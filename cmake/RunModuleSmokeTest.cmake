...
elseif(GRAVITAS_SMOKE_CASE STREQUAL "rendering_without_backend")
    set(runtime_test_regex "^(execution_selection|execution_policy|engine_pause_execution|vn_frontend_runtime|scene_resource|scene_frame_stats_runtime|physics_controller_installation|physics_contracts)$")
    list(APPEND configure_args
...
elseif(GRAVITAS_SMOKE_CASE STREQUAL "physics_without_rendering")
    set(runtime_test_regex "^(execution_selection|execution_policy|scene_resource|physics_controller_installation|physics_transform_integration|physics_contracts)$")
    list(APPEND configure_args
        -DGTS_ENABLE_RENDERING=OFF
        -DGTS_ENABLE_VULKAN_BACKEND=OFF
        -DGTS_ENABLE_PHYSICS=ON
...
elseif(GRAVITAS_SMOKE_CASE STREQUAL "debugdraw_without_physics")
    ...
    set(runtime_test_regex "^(execution_selection|execution_policy|engine_pause_execution|vn_frontend_runtime|debugdraw_runtime|scene_frame_stats_runtime)$")
elseif(GRAVITAS_SMOKE_CASE STREQUAL "debugdraw_with_physics")
    ...
    set(runtime_test_regex "^(execution_selection|execution_policy|engine_pause_execution|vn_frontend_runtime|debugdraw_runtime|physics_debugdraw_runtime|scene_frame_stats_runtime|physics_controller_installation)$")
