...
namespace gts::assets
{
    ...
    inline std::filesystem::path expectedCookedModelAssetPath(const std::filesystem::path& sourcePath)
    {
        auto cookedPath = sourcePath;
        cookedPath.replace_extension(".gmodel");
        return cookedPath;
    }
