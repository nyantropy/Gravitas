...
namespace gts::rendering::benchmarks
{
    ...
    std::string benchmarkResultSummary(const BenchmarkRunResult& result)
    {
        ...
        const std::vector<SubmitTimingRow> submitRows = {
            ...
            {"backend_cmd_record_cpu", "cmd record", true},
            {"backend_cmd_begin_cpu", "cmd begin", false},
            {"backend_framegraph_cpu", "framegraph", true},
            {"backend_framegraph_barrier_cpu", "barriers", false},
            {"backend_scene_record_cpu", "scene record", false},
            {"backend_particle_record_cpu", "particle record", false},
            {"backend_ui_record_cpu", "ui record", false},
            {"backend_editor_preview_scene_record_cpu", "preview scene", false},
            {"backend_editor_preview_particle_record_cpu", "preview particles", false},
            {"backend_upscale_record_cpu", "upscale", false},
            {"backend_other_record_cpu", "other record", false},
            {"backend_cmd_end_cpu", "cmd end", false},
