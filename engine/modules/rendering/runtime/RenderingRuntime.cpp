...
namespace gts::rendering
{
                                       ...
                                       ProfileAccumulator& profiler)
    {
        ...
        stats.renderGpuFullScanVisitedCount = renderMetrics.fullScanRenderablesVisited;
        stats.renderGpuQueuedCount = renderMetrics.queuedRenderables;
        stats.renderGpuQueueDrainedCount = renderMetrics.queuedEntriesDrained;
        stats.renderGpuStaleSkippedCount = renderMetrics.staleQueueEntriesSkipped;
        stats.renderGpuMissingComponentSkippedCount = renderMetrics.missingComponentEntriesSkipped;
        stats.renderGpuUnchangedSkippedCount = renderMetrics.unchangedVersionsSkipped;
        stats.renderGpuChangedSyncCount = renderMetrics.changedTransformsSynchronized;
        stats.renderGpuMatrixCopyCount = renderMetrics.modelMatricesCopied;
        stats.renderGpuObjectUploadRequestCount = renderMetrics.objectUploadRequests;
        stats.renderGpuDuplicateQueueAttemptCount = renderMetrics.duplicateQueueAttempts;
        stats.renderGpuQueueDeduplicationCount = renderMetrics.queueDeduplications;
        stats.renderGpuObjectSlotLookupFailureCount = renderMetrics.objectSlotLookupFailures;
        stats.renderGpuSyncWorkItemCount = renderMetrics.syncWorkItems;
        stats.renderGpuSyncBatchCount = renderMetrics.syncBatches;
        stats.renderGpuSyncMaxBatchSize = renderMetrics.syncMaxBatchSize;
        stats.renderGpuSyncAverageBatchSize = renderMetrics.syncAverageBatchSize;
        stats.renderGpuSyncStateUpdateCount = renderMetrics.syncStateUpdates;
        stats.renderGpuSyncSnapshotInvalidationCount = renderMetrics.syncSnapshotInvalidations;
        stats.renderGpuEcsLookupGatherCount = renderMetrics.ecsLookupsDuringGather;
        stats.renderGpuEcsLookupPublishCount = renderMetrics.ecsLookupsDuringPublish;
        ...
        stats.renderGpuCandidateDiscoveryCpuMs = renderMetrics.candidateDiscoveryCpuMs;
        stats.renderGpuInputGatherCpuMs = renderMetrics.inputGatherCpuMs;
        stats.renderGpuValidationCpuMs = renderMetrics.validationCpuMs;
        stats.renderGpuVersionCheckCpuMs = renderMetrics.versionCheckCpuMs;
        stats.renderGpuBatchProcessingCpuMs = renderMetrics.batchProcessingCpuMs;
        stats.renderGpuOutputMergeCpuMs = renderMetrics.outputMergeCpuMs;
        stats.renderGpuMatrixCopyCpuMs = renderMetrics.matrixCopyCpuMs;
        stats.renderGpuObjectUploadEnqueueCpuMs = renderMetrics.objectUploadEnqueueCpuMs;
        stats.renderGpuSnapshotInvalidationCpuMs = renderMetrics.snapshotInvalidationCpuMs;
        stats.renderGpuQueueCleanupCpuMs = renderMetrics.queueCleanupCpuMs;
        ...
        stats.transformChangedRootCount = transformMetrics.changedRoots;
        stats.transformWorkItemCount = transformMetrics.workItems;
        stats.transformBatchCount = transformMetrics.batches;
        stats.transformHierarchyLevelCount = transformMetrics.hierarchyLevels;
        stats.transformMaxBatchSize = transformMetrics.maxBatchSize;
        stats.transformDuplicateWorkRemovedCount = transformMetrics.duplicateWorkRemoved;
        stats.transformAverageBatchSize = transformMetrics.averageBatchSize;
        stats.transformResolveCpuMs = transformMetrics.cpuTimeMs;
        stats.transformWorkCollectionCpuMs = transformMetrics.workCollectionCpuMs;
        stats.transformHierarchySchedulingCpuMs = transformMetrics.hierarchySchedulingCpuMs;
        stats.transformInputGatherCpuMs = transformMetrics.inputGatherCpuMs;
        stats.transformMatrixCalculationCpuMs = transformMetrics.matrixCalculationCpuMs;
        stats.transformChangedListEmissionCpuMs = transformMetrics.changedListEmissionCpuMs;
        ...
        stats.snapshotUpdateWorkItemCount = snapMetrics.updateWorkItems;
        stats.snapshotUpdateBatchCount = snapMetrics.updateBatches;
        stats.snapshotRefreshedEntryCount = snapMetrics.refreshedEntries;
        stats.snapshotFullRebuildCount = snapMetrics.fullRebuilds;
        stats.snapshotStorageReallocationCount = snapMetrics.storageReallocations;
        stats.snapshotMaxBatchSize = snapMetrics.maxBatchSize;
        stats.snapshotAverageBatchSize = snapMetrics.averageBatchSize;
        stats.snapshotDirtyCollectionCpuMs = snapMetrics.dirtyCollectionCpuMs;
        stats.snapshotInputGatherCpuMs = snapMetrics.inputGatherCpuMs;
        stats.snapshotEntryRefreshCpuMs = snapMetrics.entryRefreshCpuMs;
        stats.snapshotAggregateMergeCpuMs = snapMetrics.aggregateMergeCpuMs;
