...
namespace gts::tools
{
    ...
    public:
                   ...
                   const UiLayoutSpec& layout)
        {
            ...
            toolui::setRectPayload(context.ui, context.surface, rowPanel.root(), ToolTheme::inspectorRowBackground);
        ...
        void sync(gts::ui::UiWidgetContext& context, bool rowVisible, const ToolPropertyDescriptor& descriptor)
        {
            ...
            toolui::setRectPayload(context.ui, context.surface, rowPanel.root(), fill);
    ...
    public:
                   ...
                   const UiLayoutSpec& layout)
        {
            ...
            for (size_t sectionIndex = 0; sectionIndex < MaxSections; ++sectionIndex)
            {
                ...
                toolui::setRectPayload(context.ui,
                                       context.surface,
