...
// a basic camera system that calculates the view and projection matrix for any given camera
// can be overwritten with a different system, if desired
class CameraSystem : public ECSSimulationSystem
{
    public:
