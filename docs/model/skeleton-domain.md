...
`modules/model/domain/skeleton/` owns `GtsSkeletonAsset`, an immutable reusable
...
`tests/model/domain/skeleton/GtsSkeletonAssetTest` and `GtsSkeletonCompatibilityTest`
