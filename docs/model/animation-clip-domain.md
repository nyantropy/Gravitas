...
`modules/model/domain/animation/` owns `GtsAnimationClipAsset` and CPU-only validation
...
`tests/model/domain/animation/GtsAnimationClipAssetTest.cpp` links only
